...
// --- FIX: Import the ProfilePictureManager from the customer section ---
import ProfilePictureManager from "../../../customer/pages/Account/ProfilePictureManager";
    ...
    <div className="lg:px-20 pt-5 pb-20 space-y-20">
      <div className="w-full lg:w-[70%]">
        <div className="flex items-center pb-3 justify-between">
          {/* --- FIX: Display dynamic seller name --- */}
          <h1 className="text-2xl font-bold text-gray-600">
            {sellers.profile?.sellerName || "Seller Profile"}
          </h1>
          <div>
            <Button
        ...
        <div className="space-y-5">
          ...
          {/* --- FIX: Using the dynamic ProfilePictureManager component --- */}
